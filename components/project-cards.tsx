...
const projects = [
  ...
  },
  {
    ...
    description: "Logistic regression model estimating cardiovascular mortality risk using 12 clinical features. Analysis performed using JASP software, achieving 85.6% accuracy with AUC of 0.897.",
    icon: Activity,
